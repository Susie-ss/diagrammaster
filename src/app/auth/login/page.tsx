      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        <form onSubmit={handleSubmit} className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 space-y-5">
          ...
          <p className="text-center text-sm text-slate-400">
            还没有账户？{" "}
            <Link href="/auth/register" className="text-indigo-400 hover:text-indigo-300 transition-colors">注册</Link>
          </p>
        </form>

        <p className="text-center text-xs text-slate-500 mt-6">© 2024 DiagramMaster - 专业制图工具</p>
      </div>
    </div>
  );
}
